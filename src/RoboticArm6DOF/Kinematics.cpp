...
lra::JointAngles lra::Kinematics::GetInverseKinematics(bool& is_valid, const glm::ivec3& target, float phi) {
	return GetInverseKinematics(is_valid, target, registry.store<Controller>().lra_dimension, phi);
}
