...
void lra::Sorting::SetParameters(SelectedBall ball, glm::ivec2 pos) {
	...
	animation.step_array[S5_PLACE_UPPER_GC].target_position = { destination.x, REST_POS_Y, destination.z };
	animation.step_array[S6_PLACE_LOWER_GC].target_position = { destination.x, destination.y, destination.z };
	animation.step_array[S7_PLACE_LOWER_GO].target_position = { destination.x, destination.y, destination.z };
	animation.step_array[S8_PLACE_UPPER_GO].target_position = { destination.x, REST_POS_Y, destination.z };
