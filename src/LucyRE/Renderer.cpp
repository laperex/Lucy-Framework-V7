...
#define SHADER_PATH(rel_filepath) "D:\\C++\\Lucy Framework V7\\src\\LucyRE\\Shaders\\" + std::string(rel_filepath)
...
void lre::Test() {
	...
	lre::Vertex::P1N1UV1 test_vertices[] = {
	...
	static lgl::VertexArray* vertexarray = lre::Vertex::P1N1UV1::VertexArray();
	...
	auto* shader = lre::GetShader("uv");
	shader->Bind();
	shader->SetUniformi("u_texture", 0);
	// shader->SetUniformVec4("u_color", &glm::vec4(0, 1, 1, 1)[0]);
